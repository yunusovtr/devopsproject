...
Мониторинг и логирование разворачиваются в пространство имён monitoring и доступны в графане по ссылке /grafana домена третьего уровня (например https://yunusovtr.my.to/grafana). В поиске дэшбордов можно найти Search Engine Dashboard - демонстрационный дэшборд приложения, включающий несколько метрик из компонентов и вывод их логов.
